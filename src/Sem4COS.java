...
public class Sem4COS extends JFrame implements ActionListener {    
    JTable j;
    JLabel lb;
	JButton bt;		
    Sem4COS() 
    {   
        ...
        String[][] data = { {"   1 ", "  Abraham Silberschatz, Peter Baer Galvin and Greg Gagne ", "  John Wiley &Sons, Inc ", "Rs 570 "  }, 
