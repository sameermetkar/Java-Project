...
public class Sem4AS extends JFrame implements ActionListener{    
    JTable j;
    JLabel lb;
	JButton bt;		
    Sem4AS() 
    {   
        ...
        setTitle("Automata Theory"); 
        
        String[] columnNames = {"Sr. NO", "Author", "Publication", "Price" }; 
        
        String[][] data = { {"   1 ", "   Kavi Mahesh  ", "   Wiley India ", "   Rs 600 " },
        	    { "   2 ","   J.C.Martin ", "   TMH" , "   Rs 650 "}
         }; 
