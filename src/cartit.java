...
public class cartit extends JFrame implements ActionListener{
  ...
  cartit()
    {        
        ...
        setTitle("YOUR CART FOR IT BOOKS"); 
        
        Object[] columnNames = {"Author", "Publication"," Nos "}; 
...
{
	 setVisible(false);
     thirdpageit ct = new thirdpageit();
     ct.setVisible(true); 
}
